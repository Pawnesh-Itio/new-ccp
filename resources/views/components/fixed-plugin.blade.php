    ...
    <div class="card shadow-lg ">
        <div class="card-header pb-0 pt-3 ">
            <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
                <!-- <h5 class="mt-3 mb-0">CCP
                    <div x-data="{ show: true}" x-init="setTimeout(() => show = false, 4000)" x-show="show"
                        class="position-fixed bg-success rounded right-3 text-sm py-2 px-4"> Configurator
                </h5> -->
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <div class="form-check form-switch ps-0">
                <input class="form-check-input mt-1 ms-auto  {{ (Request::is('rtl') ? 'float-end' : '') }}"" type="
                    checkbox" id="navbarFixed" onclick="navbarFixed(this)">
            </div>
