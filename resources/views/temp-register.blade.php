...
<body class="g-sidenav-show  bg-gray-100  ">
                            ...
                            <ul class="navbar-nav mx-auto">
                                <li class="nav-item">
                                    <a class="nav-link me-2"
                                        href="https://soft-ui-dashboard-laravel.creative-tim.com/register">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link me-2"
                                        href="https://soft-ui-dashboard-laravel.creative-tim.com/login">
                            ...
                            <ul class="navbar-nav d-lg-block d-none">
                                <li class="nav-item">
                                    <a href="https://www.creative-tim.com/product/soft-ui-dashboard-laravel"
                                        target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Free
                                        download</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" id="registerForm" action="{{route('register')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <!-- Start Left Col -->
                                    <div class="col">
                                        <div class="mb-3">
                                            <select name="slug" class="form-control" id="slug" aria-label="slug"
                                        ...
                                        <div class="mb-3">
                                            <select name="state" class="form-control" id="state" aria-label="state"
                                                aria-describedby="state">
                                                <option value>Please Select Your State</option>
                                                @foreach($state AS $s_d)
                                                <option class="text-uppercase" value="{{$s_d->state}}">{{$s_d->state}}
                                                </option>
                                                @endforeach
                                            </select>
                                            @error('type')
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control" placeholder="Shop Name"
                                                name="shopname" id="shopname" aria-label="shopname"
                                                aria-describedby="shop-addon">
                                            @error('shopname')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" placeholder="Aadhar Number"
                                                name="aadharcard" id="aadharcard" aria-label="aadharcard"
                                                aria-describedby="aadhar-addon">
                                            @error('aadharcard')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <textarea type="text" class="form-control" name="address" id="address"
                                                ...
                                                aria-describedby="pannumber-addon"></textarea>
                                            @error('address')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            <input type="tel" class="form-control" placeholder="Mobile" name="mobile"
                                                id="moblie" aria-label="mobile" aria-describedby="mobile-addon">
                                            @error('mobile')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" placeholder="City" name="city"
                                                id="city" aria-label="city" aria-describedby="city-addon">
                                            @error('city')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" placeholder="Pincode Number"
                                                name="pincode" id="pincode" aria-label="pincode"
                                                aria-describedby="pincode-addon">
                                            @error('pincode')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" placeholder="Pan Number"
                                                name="pancard" id="pancard" aria-label="pancard"
                                                aria-describedby="pancard-addon">
                                            @error('pancard')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"84d0f4923c010e1c","version":"2024.1.0","token":"1b7cbb72744b40c580f8633c6b62637e"}'
