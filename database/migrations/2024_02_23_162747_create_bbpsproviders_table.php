...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('bbpsproviders', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('name');
            $table->string('recharge1')->nullable();
            $table->string('recharge2')->nullable();
            $table->string('recharge3', 250)->nullable();
            $table->integer('api_id')->nullable();
            $table->enum('type', ['mobile', 'dth', 'electricity', 'pancard', 'dmt', 'aeps', 'fund', 'nsdlpan', 'tax', 'lpggas', 'gasutility', 'landline', 'postpaid', 'broadband', 'water', 'loanrepay', 'lifeinsurance', 'fasttag', 'cable', 'insurance', 'schoolfees', 'muncipal', 'housing', 'idstock'])->default('mobile');
    ...
    {
        Schema::dropIfExists('bbpsproviders');
    }
};
