...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('aepsreports', function (Blueprint $table) {
            ...
            $table->enum('status', ['initiated', 'success', 'pending', 'failed', 'complete', 'reversed', 'refunded'])->default('initiated');
            ...
            $table->enum('aepstype', ['MS', 'BE', 'CW', 'matm', 'AP', 'UPI', 'upicollect', 'payout'])->default('MS');
            ...
            $table->string('product', 250)->default('aeps');
    ...
    {
        Schema::dropIfExists('aepsreports');
    }
};
